...
console.log("2. Find all the employee from IT or HR dept");
...
console.log("4. Find all the employee whose whose name start with A, V, or M");
...
console.log("5. Find the average salary of employee for all the department");
const newArray = []
